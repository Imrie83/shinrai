import {
  AlignLeft, Layers, Globe, BarChart3,
  Search, FileText, Wrench, TrendingUp,
  Languages, Award, Clock, User,
...
const T = {
  en: {
    ...
    problems: [
      { icon: AlignLeft, title: "Unnatural English",  desc: "Machine-translated copy that reads awkwardly, making it harder for visitors to trust the message." },
      { icon: Layers,    title: "Missing Context",    desc: "Details that Japanese readers understand intuitively often need to be made explicit for overseas audiences." },
      { icon: Globe,     title: "Tone Mismatch",      desc: "Writing style tuned for a Japanese audience can feel distant or unclear to English-speaking visitors." },
      { icon: BarChart3, title: "Unclear Next Steps", desc: "Contact flows and calls-to-action that work well in Japanese sometimes don't translate directly." },
    ],
    ...
    process: [
      { icon: Search,     step: "01", title: "Audit",  desc: "I review your site in detail and document every opportunity to improve." },
      { icon: FileText,   step: "02", title: "Report", desc: "You receive a clear, prioritised report — plain language, no jargon." },
      { icon: Wrench,     step: "03", title: "Fix",    desc: "I implement changes directly, or provide ready-to-use copy and guidance." },
      { icon: TrendingUp, step: "04", title: "Review", desc: "We go through the changes together and refine until everything feels right." },
    ],
    trustLabel: "Why Me",
    trustTitle: "Why Businesses Work With Me",
    trustSub:   "Not an agency. Not a template service. A developer who also writes.",
    trustList: [
      { icon: Languages, title: "Developer + Localization",   desc: "I understand the technical side and the language side — fewer handoff problems, faster results." },
      { icon: Award,     title: "Human Writing, AI-Assisted", desc: "I use AI tools for research and speed, but every sentence is written and reviewed by me." },
      { icon: Clock,     title: "Fast Turnaround",            desc: "Audit reports within 48 hours. Most full projects delivered within one to two weeks." },
      { icon: User,      title: "Direct Communication",       desc: "You work with me directly, in English or Japanese, with no intermediaries." },
    ],
    ...
    bioTechGroups: [
      { icon: Code,       label: "Frontend", techs: ["React", "Next.js", "TypeScript", "Tailwind CSS", "Vue.js"] },
      { icon: Server,     label: "Backend",  techs: ["Node.js", "Python", "PHP", "REST APIs", "GraphQL"] },
      { icon: Database,   label: "Data",     techs: ["PostgreSQL", "MySQL", "MongoDB", "Redis", "Supabase"] },
      { icon: Smartphone, label: "Tooling",  techs: ["Git", "Docker", "Vercel", "AWS", "CI/CD"] },
    ],
  ...
  ja: {
    ...
    problems: [
      { icon: AlignLeft, title: "不自然な英語表現",      desc: "機械翻訳の文章は読みにくく、訪問者に信頼感を与えにくい場合があります。" },
      { icon: Layers,    title: "前提知識の差",           desc: "日本人には自明のことでも、海外ユーザーには補足が必要な情報があります。" },
      { icon: Globe,     title: "トーンのズレ",           desc: "日本語で自然な表現も、英語圏のユーザーには距離感や分かりにくさを生むことがあります。" },
      { icon: BarChart3, title: "次のアクションが不明確", desc: "日本語サイトで機能するお問い合わせ導線も、英語ではそのまま使えないことがあります。" },
    ],
    solutionLabel: "対応内容",
    ...
    process: [
      { icon: Search,     step: "01", title: "診断",       desc: "サイト全体を確認し、改善点を丁寧にまとめます。" },
      { icon: FileText,   step: "02", title: "レポート",   desc: "専門用語なし、わかりやすい優先順位付きレポートをお届けします。" },
      { icon: Wrench,     step: "03", title: "改善",       desc: "直接実装するか、すぐに使えるコピーと提案をご提供します。" },
      { icon: TrendingUp, step: "04", title: "確認・調整", desc: "一緒に内容を確認しながら、納得いくまで仕上げます。" },
    ],
    trustLabel: "選ばれる理由",
    trustTitle: "Shinraiが選ばれる理由",
    trustSub:   "代理店でも、テンプレートサービスでもない。開発もできる、書き手がいます。",
    trustList: [
      { icon: Languages, title: "開発者＋ローカライズの専門家", desc: "技術と言語の両方を理解しているため、引き継ぎの手間が少なく、対応がスムーズです。" },
      { icon: Award,     title: "AIを活用した人間の文章",        desc: "AIをリサーチや効率化に活用しつつ、すべての文章は私自身が書き、確認します。" },
      { icon: Clock,     title: "スピード対応",                  desc: "診断レポートは48時間以内。ほとんどのプロジェクトは1〜2週間以内に完了します。" },
      { icon: User,      title: "ダイレクトなやりとり",          desc: "仲介なし。日本語・英語どちらでも、直接対応します。" },
    ],
    caseLabel: "プロジェクト例",
    ...
    bioTechLabel: "技術スタック",
    bioTechGroups: [
      { icon: Code,       label: "フロントエンド", techs: ["React", "Next.js", "TypeScript", "Tailwind CSS", "Vue.js"] },
      { icon: Server,     label: "バックエンド",   techs: ["Node.js", "Python", "PHP", "REST API", "GraphQL"] },
      { icon: Database,   label: "データ",         techs: ["PostgreSQL", "MySQL", "MongoDB", "Redis", "Supabase"] },
      { icon: Smartphone, label: "ツール・環境",   techs: ["Git", "Docker", "Vercel", "AWS", "CI/CD"] },
    ],
    formLabel: "無料診断",
    formTitle: "無料診断を申し込む",
