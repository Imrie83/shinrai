...
export const T = {
  en: {
    ...
    auditCtaText:  "Want all issues fixed by a professional?",
  ...
  ja: {
    ...
    bioCopy: "私はフルスタックエンジニアとして、長年にわたり言語とUXが製品の国際的な受け取られ方に与える影響に関心を持ってきました。技術的に優れた日本のプロダクトが、英語サイトの問題で海外顧客に届いていない場面を繰り返し目にしてきたことが、Shinraiを立ち上げたきっかけです。開発者としての視点があるため、コピーの書き直しだけでなく、構造やUXの課題も特定・修正できます。",
    bioTechLabel: "技術スタック",
    bioTechGroups: [
    ...
    auditCtaText:  "すべての問題をプロに解決してほしいですか？",
