...
const ROWS_JA = [
  ...
  ["電話番号","【電話番号】（メールでのお問い合わせを推奨します）"],["メールアドレス","[your@email.com]"],
...
const ROWS_EN = [
  ["Seller","Marcin Zielinski"],["Address","[City, Country — full address on request]"],
  ["Phone","[Phone number] — email contact preferred"],["Email","[your@email.com]"],
